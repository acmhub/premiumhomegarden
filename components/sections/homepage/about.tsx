...
function About() {
	return (
		<section className="relative container section-spacing">
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 max-w-6xl mx-auto gap-8 lg:gap-20">
				...
				<div className="space-y-4 my-auto">
					...
					<p>
						...
						produselor premium pe care le utilizăm asigurăm parteneriate de lungă durată adaptându-ne
						ultimelor tendințe și investind în dezvoltarea serviciilor noastre.
					</p>
					...
					<Link href="/despre-noi" className="button button-khaki w-fit">
						Mai multe detalii
					</Link>
				</div>
			</div>
